...
equipment worn on the front of a players shin to protect them from injury.''', 
             Category_id=1)
session.add(Item1)
session.commit()
...
session.add(Item2)
session.commit()
Item3 = Item(name="Soccer Cleats", description="The shoes", 
             categories=Category)
session.add(Item3)
session.commit()
...
session.commit()
Item5 = Item(name="Frisbee", 
             description='''A frisbee is a gliding toy or sporting item that is
              generally plastic and roughly 8 to 10 inches (20 to 25 cm) 
              in diameter with a pronounced lip.''', 
...
Item6 = Item(name="Goggles", 
             description='''Goggles, or safety glasses, are forms
              of protective eyewear that usually enclose or protect 
...
session.commit()
Item8 = Item(name="Stick", 
             description='''A hockey stick is a piece of sport
              equipment used by the players in all the forms of hockey
              to move the ball or puck  either to push, pull, hit, strike,
            flick, steer, launch or stop the ball/puck during play with the 
            objective being to move the ball/puck around the playing area
             using the stick.''',
